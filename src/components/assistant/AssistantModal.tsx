...
import type { LlmMessagePart, Script } from '../../types/script.js';
import type { LlmMessageDTO } from 'lumiverse-spindle-types';
import type { AssistantThreadIndexEntry, AppliedEvent } from '../../assistant/types.js';
 ...
 */
function historyToDisplay(history: LlmMessageDTO[], appliedEvents: AppliedEvent[] = []): DisplayMessage[] {
