...
export const TRIGGER_EVENT_GROUPS: EventGroup[] = [
  {
    ...
    events: [
      ...
      { name: 'MESSAGE_SWIPED',             description: 'A message was swiped to an alternate' },
  ...
  },
  {
    label: 'Entities',
    events: [
      { name: 'CHAT_CHANGED',         description: 'Active chat changed (open/close/switch)' },
  ...
  },
  {
    label: 'Settings',
    events: [
      { name: 'SETTINGS_UPDATED',          description: 'A setting was updated' },
